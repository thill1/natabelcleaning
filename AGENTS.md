...
- Pre-launch TODOs for real data: business phone (placeholder `(916) 555-0148`), license number (`Lic# pending`), Fatima's real portrait for the homepage founder section (Unsplash placeholder now), `PCC.leads.endpoint` (leads are in demo mode), and `PCC.pricing` anchors.
